...
SYSTEM_PROMPT = (
    ...
    "WALLETS: 'which/how many smart wallets', 'wallets I added/track' all → get_smart_wallets. "
    "Use the 'total' field (typically 204) — NEVER say 'none' just because the word 'added' "
    "appears. Only filter to manual_count if user explicitly says 'manually added by me'.\n\n"
